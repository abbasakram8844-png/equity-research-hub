...
def fetch_quote(symbol: str):
    ...
    # Try 2: SME with SME-specific referer
...
if failed:
    st.warning(
        ...
        f"For SME stocks (NSE EMERGE), data feed is unreliable from cloud. "
        f"Try 🔄 Refresh, or remove from watchlist.txt and track manually on Tickertape."
    )
